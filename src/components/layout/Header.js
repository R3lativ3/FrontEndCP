...
import { Row, Col, Breadcrumb, Badge, Dropdown, Button, List, Avatar, Drawer, Typography } from "antd";
...
function Header({ placement, name, subName, onPress }) {
  ...
  const { logout, getUserLogged } = useContext(AuthContext)
          ...
          >
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Opciones
                  <Text className="subtitle">Opciones de usuario</Text>
                </Title>
              </div>

              <div className="sidebar-color">
                <Title level={5}>{getUserLogged().username}</Title>
                <div className="ant-docment">
                  <ButtonContainer>
                    <Button size="large" onClick={logout}>CERRAR SESION</Button>
                  </ButtonContainer>
                </div>
              </div>
            </div>
